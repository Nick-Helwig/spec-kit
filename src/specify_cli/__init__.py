...
def init(
    ...
    if selected_ai == "codex":
        ...
        if not codex_config_updated:
            console.print(
                ...
                f"Point the MCP server at [cyan]{codex_server_js_path.as_posix()}[/cyan] and pass "
                f"[cyan]--agents-dir {_codex_agents_dir(project_path).as_posix()}[/cyan] manually."
            )
    ...
    steps_lines.append("   2.6 [cyan]/speckit.review[/] - Run findings-first review before merge/deploy")
